...
const Page = () => {
  ...
  return (
    <div className="relative flex items-center justify-center flex-col p-4">
      ...
      {mealsData.map((meal) => (
        <Link href={`/${meal.id}`} key={meal.id} className={`w-[30rem] mb-6 p-4 border rounded-lg shadow-md bg-white ${interStyles} hover:scale-[1.01]`}>
